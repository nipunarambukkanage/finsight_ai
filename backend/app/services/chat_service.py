...
class AIChatAssistantService:
    ...
    async def process_chat(self, req: AIChatRequest) -> AIChatResponse:
        ...
        # Extract ticker if present in query or request
        ticker = req.ticker
        if not ticker:
        ...
        # 4. Document / Filing Retrieval Intent (RAG)
        ...
        # 5. General Stock Overview & Fundamentals
        elif ticker:
            ...
            response_text = await provider.generate(query)
